            ...
            <div class="row h-100">
                <div class="col-md-7 col-12 m-auto">
                    <div id="auth-left">
                        ...
                        <h1 class="auth-title mb-0">Laratask</h1>
                        ...
                        @else
                            <form method="POST" action="" class="col-md-12 mt-5">
                                @csrf
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary font-bold col-5 m-2 " id="submit">
                                            {{ __('Login') }}
                                        </button>
